...
{
    public class RepositorioBasePet<TEntidade> : IRepositorioBase<TEntidade>
        where TEntidade : EntidadeBase
    {
        protected readonly ContextoPet contexto;

        public RepositorioBasePet(ContextoPet contexto)
            : base()
        {
